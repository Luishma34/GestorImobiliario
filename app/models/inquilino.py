...
class InquilinoBase(SQLModel):
    ...
    email: str = Field(default=None, max_length=100, description="Email do inquilino")
    telefone: str = Field(max_length=20, description="Telefone do inquilino")
    endereco_anterior: str = Field(default=None, max_length=600, description="Endereço anterior do inquilino")
    renda_mensal: float = Field(default=None, gt=0, description="Renda mensal do inquilino")
...
class InquilinoUpdate(SQLModel):
    ...
    endereco_anterior:  str | None = Field(default=None, max_length=600)
