...
class ProprietarioBase(SQLModel):
    ...
    email: str | None = Field(default=None, max_length=100, description="Email do proprietário")
    telefone: str = Field(max_length=20, description="Telefone do proprietário")
    endereco: str | None = Field(default=None, max_length=600, description="Endereço do proprietário")
...
class ProprietarioUpdate(SQLModel):
    ...
    endereco:  str | None = Field(default=None, max_length=600)
